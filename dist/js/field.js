...
Nova.booting(function (Vue, router) {
    Vue.component('index-order-field', __webpack_require__(3));
    Vue.component('detail-order-field', __webpack_require__(6));
    Vue.component('form-order-field', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		...
		update: function update() {
			Nova.request().post('/nova-vendor/michielkempen/nova-order-field', {
...
var render = function() {
  ...
  return _c("div", { staticClass: "flex items-center" }, [
    ...
    _c(
      "button",
      {
        staticClass: "cursor-pointer text-70 hover:text-primary ml-3",
        on: { click: _vm.plus }
      },
      [
        _c(
